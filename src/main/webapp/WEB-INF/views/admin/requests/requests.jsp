...
<head>
    ...
    <title>Demandes d'inscription | Tableau de bord Admin</title>
...
<div class="container">
    <div class="sidebar">
        ...
        <ul>
            ...
            <li><a href="${pageContext.request.contextPath}/admin/requests" class="active">Demandes d'inscription</a></li>
