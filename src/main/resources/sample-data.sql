...
INSERT INTO students (id, email, firstname, lastname, date_of_birth, is_verified) VALUES
    ...
    (UNHEX(REPLACE('c9f6e1a8-2d8b-4f3c-9e0d-5b9f3d8a0c7f', '-', '')), 'unverified@example.com', 'Charlie', 'Brown', '2002-05-15', 0);
...
INSERT INTO grades (id, score, assignment_id, enrollment_id) VALUES
     ...
     (UNHEX(REPLACE('a1b3e1d4-3f89-4b2f-9576-b4e8d0e9f8b2', '-', '')), 15.5, UNHEX(REPLACE('543f03b8-2df0-4404-9840-80ce3eed9d31', '-', '')), UNHEX(REPLACE('1bcf76e1-08b3-4c12-b654-c7f5a0f6aa01', '-', ''))), -- Newton's Laws
     (UNHEX(REPLACE('f3d2e0a6-3c4a-4f8e-95b3-d1b4e0f8c7a5', '-', '')), 17.5, UNHEX(REPLACE('acb113f2-8b36-4b89-8391-8e9a78707744', '-', '')), UNHEX(REPLACE('1bcf76e1-08b3-4c12-b654-c7f5a0f6aa01', '-', ''))), -- Energy Concepts

     -- Grades for Bob in Chemistry
     (UNHEX(REPLACE('c3d8a3f7-8f4c-4f72-98c4-5b8e0d2e9f1b', '-', '')), 18.5, UNHEX(REPLACE('96a786c7-3696-4938-a147-969e86df4efc', '-', '')), UNHEX(REPLACE('3f22c5eb-64f4-4c08-914f-99d737ddf586', '-', ''))), -- Chemical Reactions
     (UNHEX(REPLACE('d4e9b1f8-9f6d-4b8e-b5c7-6a9f1e0d8a3e', '-', '')), 17.75, UNHEX(REPLACE('db8deae5-ea2d-4f6e-bb65-83b856ca90c1', '-', '')), UNHEX(REPLACE('3f22c5eb-64f4-4c08-914f-99d737ddf586', '-', ''))), -- Atomic Structure
     ...
     (UNHEX(REPLACE('f1e3b5d8-7a9e-4f8b-9574-6b5d1f9e2c3a', '-', '')), 17.5, UNHEX(REPLACE('3a62f67d-1a2e-4af1-bcf4-7f9f4b5366e4', '-', '')), UNHEX(REPLACE('0233b482-8d18-4fb5-92eb-2ed6737931bf', '-', ''))), -- Algebra Basics
     (UNHEX(REPLACE('a9d7c1e5-4b8a-4e5b-9476-6a8e1d2b9c3f', '-', '')), 18.25, UNHEX(REPLACE('442ddaf5-3845-4ee6-b48e-071e0a9c2d9f', '-', '')), UNHEX(REPLACE('0233b482-8d18-4fb5-92eb-2ed6737931bf', '-', ''))); -- Linear Equations
